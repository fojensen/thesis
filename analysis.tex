...
\includegraphics[width=\textwidth]{figs/CMS-SUS-17-006_Figure_001.pdf}
\caption{The T5HH model.}
\label{fig:t5hh}
\end{subfigure}
\begin{subfigure}[b]{0.45\textwidth}
\includegraphics[width=\textwidth]{figs/CMS-SUS-17-006_Figure-aux_001.pdf}
...
\begin{figure}[hbp!]
\centering
\includegraphics[width=0.45\linewidth]{figs/J1BB_LooseJetMass.pdf}
\includegraphics[width=0.45\linewidth]{figs/J2pt_BBtag_baseline.pdf}\\
\includegraphics[width=0.45\linewidth]{figs/J1Mwide_JetPt.pdf}
\includegraphics[width=0.45\linewidth]{figs/J2Mwide_JetPt.pdf}\\
\caption{
...
\begin{figure}[hbp!]
 \centering
 \includegraphics[trim={5px 5px 5px 5px},clip,width=0.45\linewidth]{figs/ABCDscaleFactors_MET_antitagSB_photon.pdf}
 \includegraphics[trim={5px 5px 5px 5px},clip,width=0.45\linewidth]{figs/ABCDscaleFactors_MET_antitagSR_photon.pdf}\\
 \includegraphics[trim={5px 5px 5px 5px},clip,width=0.45\linewidth]{figs/ABCDscaleFactors_MET_single-tagSB_photon.pdf}
 \includegraphics[trim={5px 5px 5px 5px},clip,width=0.45\linewidth]{figs/ABCDscaleFactors_MET_single-tagSR_photon.pdf}\\
 \includegraphics[trim={5px 5px 5px 5px},clip,width=0.45\linewidth]{figs/ABCDscaleFactors_MET_double-tagSB_photon.pdf}
...
\begin{figure}[hbp!]
\centering
\includegraphics[trim={5px 5px 5px 5px},clip,width=0.45\linewidth]{figs/ABCDscaleFactors_MET_antitagSB_lowDeltaPhi_singleLep.pdf}
\includegraphics[trim={5px 5px 5px 5px},clip,width=0.45\linewidth]{figs/ABCDscaleFactors_MET_antitagSR_lowDeltaPhi_singleLep.pdf}\\
\includegraphics[trim={5px 5px 5px 5px},clip,width=0.45\linewidth]{figs/ABCDscaleFactors_MET_tagSB_lowDeltaPhi_singleLep.pdf}
\includegraphics[trim={5px 5px 5px 5px},clip,width=0.45\linewidth]{figs/ABCDscaleFactors_MET_tagSR_lowDeltaPhi_singleLep.pdf}\\
\includegraphics[trim={5px 5px 5px 5px},clip,width=0.45\linewidth]{figs/ABCDscaleFactors_MET_double-tagSB_lowDeltaPhi_singleLep.pdf}
...
\begin{figure}[hbp!]
 \centering
 \includegraphics[trim={5px 5px 5px 5px},clip,width=0.45\linewidth]{figs/ABCDscaleFactors_MET_antitagSB_lowDphi.pdf}
 \includegraphics[trim={5px 5px 5px 5px},clip,width=0.45\linewidth]{figs/ABCDscaleFactors_MET_antitagSR_lowDphi.pdf}\\
 \includegraphics[trim={5px 5px 5px 5px},clip,width=0.45\linewidth]{figs/ABCDscaleFactors_MET_single-tagSB_lowDphi.pdf}
 \includegraphics[trim={5px 5px 5px 5px},clip,width=0.45\linewidth]{figs/ABCDscaleFactors_MET_single-tagSR_lowDphi.pdf}\\
 \includegraphics[trim={5px 5px 5px 5px},clip,width=0.45\linewidth]{figs/ABCDscaleFactors_MET_double-tagSB_lowDphi.pdf}
...
\ptmiss [700, $\infty$ GeV] &  $0.86 \pm 0.17$ & $0.62 \pm 0.30$ \\ \hline
\hline
\end{tabular}
...
\begin{subfigure}[b]{0.5\textwidth}
\centering
\includegraphics[trim={5px 5px 5px 5px},clip,width=\textwidth]{figs/MCclosureSF_singleHiggsRegionTotal.pdf}
\caption{The single Higgs tag region (A$_{1}$).}
\end{subfigure}
\begin{subfigure}[b]{0.5\textwidth}
\centering
\includegraphics[trim={5px 5px 5px 5px},clip,width=\textwidth]{figs/MCclosureSF_doubleHiggsRegionTotal.pdf} 
\caption{The double Higgs tag region (A$_{2}$).}
\end{subfigure}
...
\begin{figure}[hbp!]
\centering
\includegraphics[width=0.45\linewidth]{figs/CMS-SUS-17-006_Figure-aux_006.pdf}
\includegraphics[width=0.45\linewidth]{figs/CMS-SUS-17-006_Figure-aux_007.pdf}
\includegraphics[width=0.45\linewidth]{figs/CMS-SUS-17-006_Figure-aux_008.pdf}
\includegraphics[width=0.45\linewidth]{figs/CMS-SUS-17-006_Figure-aux_009.pdf}
