...
{Previous results for searches of gluino-mediated supersymmetry for two gluino decay models: T1tttt (left) and T1qqqqVV (right) \cite{CMS-SUS-16-033}. The excluded regions are towards the lower left.}
\label{fig:oldlimits}
\end{figure} 
